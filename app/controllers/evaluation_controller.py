        ...
        try:
            ...
            if freq is None:
                return error_response({
                    "frequency_months": "Campo requerido"
                })
...
def apply_test(self, data):
    try:
        ...
        if not any(isinstance(r.get("value"), (int, float)) and r.get("value") > 0 for r in results):
            return error_response("Debe ingresar al menos un valor válido para los ejercicios")
        ...
        for r in results:
            ...
            if not isinstance(value, (int, float)) or value <= 0:
                return error_response("Debe ingresar un valor mayor que 0 para cada ejercicio")
